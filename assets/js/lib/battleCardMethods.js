...
export const battleCard = {
    ...
    dealCard: function(game, animateCard, spaces) {
        ...
        if (game.turn.battleCard === 1) {
            ...
            game.player1.army += this.show(game.cards, spaces[game.player1.space].zone);
            ...
            animateCard(game);
            // Player gets more or less soldiers from the battle card
            game.player2.army += battleCard.show(game.cards, spaces[game.player2.space].zone);
